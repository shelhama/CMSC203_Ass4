...
public class ManagementCompanyTest {
    ...
    public void testAddPropertyWithinBounds() {
        ...
        assertEquals(2, managementCompany.addProperty(property3));
    }

    @Test
    public void testAddPropertyOutOfBounds() {
        // Adding a property that is outside the management company's plot bounds
        assertEquals(-3, managementCompany.addProperty(propertyOutOfBounds));
    }
    ...
    public void testAddPropertyArrayFull() {
        ...
        assertEquals(-4, managementCompany.addProperty(additionalProperty), "Adding property beyond capacity should return -1");
    }
    ...
    public void testGetHighestRentProperty() {
        ...
        assertEquals("City2", highestRentProperty.getCity());
        assertEquals(3000.0, highestRentProperty.getRentalAmount(), 0.0);
    }
    ...
    public void testGetPropertiesCount() {
        ...
        managementCompany.addProperty(property2);
        managementCompany.addProperty(property3);
        assertEquals(3, managementCompany.getPropertiesCount());
    }
    ...
    public void testToString() {
        ...
        assertEquals(expectedOutput.trim(), managementCompany.toString().trim());
    }
}